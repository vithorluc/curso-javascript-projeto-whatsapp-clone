...
getViewElement(me = true){
    ...
    /* 
        step three -> checks if it was myself that sent the message to the user 
    */
    ...
    /* 
    second step -> send the message with a promise with the status of the message merged with the previous data 
    of the database   
    */
    ...
    // first step -> get all the view elements of status message, OK 
