...
export class WhatsAppController{
    ...
    this.el.btnClosePanelEditProfile.on('click', e => {
        // let button = panelEditProfile.querySelector('submit')     
    ...
    this.el.inputProfilePhoto.on('change', e => {
        ...
        if (this.el.inputProfilePhoto.files.length > 0) {
            ...
            Upload.send(file, this._user.email).then(uploadTaskRef => {
    ...
    this.el.inputNamePanelEditProfile.on('keypress', e => {
        ...
        this.el.btnTakePicture.on('click', e => {
            ...
            this.el.btnRshootPanelCamera.show()
            this.el.conteinerTakePicture.hide()
            this.el.conteinerSendPicture.show()
        })
        ...
        this.el.btnReshootPanelCamera.on('click', e => {
            ...
            this.el.btnRshootPanelCamera.hide()
            this.el.conteinerTakePicture.show()
            this.el.conteinerSendPicture.hide()

        })
        // send picture and invert using canvas 
